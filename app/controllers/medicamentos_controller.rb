class MedicamentosController < ApplicationController
  ...
  def index
    @medicamentos = Medicamento.paginate(:per_page => 10, :page => params[:page], :order => 'abreviacao asc')
  ...
  def create
    ...
    respond_to do |format|
      if @medicamento.save
        format.html { redirect_to medicamentos_path, notice: 'Medicamento was successfully created.' }
